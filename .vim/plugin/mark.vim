...
function! s:DefaultHighlightings()
	...
	elseif g:mwDefaultHighlightingPalette ==# 'original'
		let l:palette = [
		\   { 'ctermfg':'Yellow',       'ctermbg':'Black', 'guibg':'#8CCBEA', 'guifg':'Black' },
		\   { 'ctermfg':'Cyan',      'ctermbg':'Black', 'guibg':'#A4E57E', 'guifg':'Black' },
		\   { 'ctermfg':'Green',     'ctermbg':'Black', 'guibg':'#FFDB72', 'guifg':'Black' },
		\   { 'ctermfg':'Red',        'ctermbg':'Black', 'guibg':'#FF7272', 'guifg':'Black' },
		\   { 'ctermfg':'Magenta',    'ctermbg':'Black', 'guibg':'#FFB3FF', 'guifg':'Black' },
		\   { 'ctermfg':'Blue',       'ctermbg':'Black', 'guibg':'#9999FF', 'guifg':'Black' },
		\]
